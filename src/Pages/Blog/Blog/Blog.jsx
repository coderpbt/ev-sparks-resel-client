  ...
  return (
    <div className="lg:w-[800px] mx-auto w-[95%] lg:my-20 my10">
      <div className="my-8 text-left">
        <h1 className="lg:text-3xl text-2xl text-white capitalize font-bold mb-2">What are the different ways to manage a state in a React application?</h1>
        <p className="text-white text-base">Beau Carnes. React state management is a process for managing the data that React components need in order to render themselves. This data is typically stored in the component's state object. When the state object changes, the component will re-render itself. React state management is basically half of a React app.
        <br />
      ...
      <div className="my-8 text-left">
        <h1 className="lg:text-3xl text-2xl text-white capitalize font-bold mb-2">How does prototypical inheritance work?</h1>
        <p className="text-white text-base">
        The Prototypal Inheritance is a feature in javascript used to add methods and properties in objects. It is a method by which an object can inherit the properties and methods of another object. Traditionally, in order to get and set the [[Prototype]] of an object, we use Object. getPrototypeOf and Object.
        </p>
      </div>
      <div className="my-8 text-left">
        <h1 className="lg:text-3xl text-2xl text-white capitalize font-bold mb-2">What is a unit test? Why should we write unit tests?</h1>
        <p className="text-white text-base">
        The main objective of unit testing is to isolate written code to test and determine if it works as intended. Unit testing is an important step in the development process, because if done correctly, it can help detect early flaws in code which may be more difficult to find in later testing stages.
        </p>
      </div>
      <div className="my-8 text-left">
        <h1 className="lg:text-3xl text-2xl text-white capitalize font-bold mb-2">React vs. Angular vs. Vue?</h1>
        <p className="text-white text-base">
